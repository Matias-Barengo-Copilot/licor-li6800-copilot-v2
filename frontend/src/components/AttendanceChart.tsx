...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#0b1b2b" }}>
        Attendance: <b>{d.attendance_rate}%</b>
      </p>
      <p style={{ color: "#c6f000" }}>Present: {d.present}</p>
      ...
      <AreaChart data={formatted} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
        <defs>
          <linearGradient id="attGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="#0b1b2b" stopOpacity={0.25} />
            <stop offset="95%" stopColor="#0b1b2b" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        <ReferenceLine
          ...
          stroke="#0b1b2b"
          strokeDasharray="4 4"
          label={{ value: "80% target", fill: "#0b1b2b", fontSize: 10, position: "insideTopRight" }}
        />
        <Area
          type="monotone"
